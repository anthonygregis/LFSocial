...
<div class="container">
    <div class="row">
        <div class="col-3 p-5">
            <img src="{{ $user->profile->image }}" width="150px" height="150px" alt="" class="rounded-circle">
        </div>
            ...
            <div class="col-12">
                <div class="row d-flex">
                    <div class="col-1 pl-5">
                        <img src="{{ $user->profile->image }}" width="45px" height="45px" alt="" class="rounded-circle">
                    </div>
                    <div class="col-11">
                        <div>{{ $user->name }}</div>
                ...
                <div class="row pl-4 pt-2 pr-5 d-flex">
                    <div class="col-1"><img src="{{ $user->profile->image }}" width="30px" height="30px" alt="" class="rounded-circle"></div>
